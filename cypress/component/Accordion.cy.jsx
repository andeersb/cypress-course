...
describe('Accordion.cy.jsx', () => {
  it('ItemsAccordion', () => {
    ...
    cy.contains('Your tests will exist in a describe block. This block takes two arguments. The first is a description of what you are testing. The second is a callback function for your actually tests within that block').should('not.be.visible')
    cy.getDataTest('accordion-item-1').click()
    cy.contains('Your tests will exist in a describe block. This block takes two arguments. The first is a description of what you are testing. The second is a callback function for your actually tests within that block').should('be.visible')
